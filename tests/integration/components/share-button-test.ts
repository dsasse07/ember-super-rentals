...
// Make a fake service like the @service router actually used
// This is called "mocking" or "stubbing"
...
module('Integration | Component | share-button', function (hooks) {
  ...
  hooks.beforeEach(function () {
    // We register a new service with Ember before each test
    this.owner.register('service:router', MockRouterService);
    this.set('text', 'Check out Grand Old Mansion on Super Rentals!');
    this.set('hashtags', 'vacation,travel,authentic,blessed,superrentals');
    this.set('via', 'emberjs');

    // Create a new getter that each test can access
    // @ts-ignore
